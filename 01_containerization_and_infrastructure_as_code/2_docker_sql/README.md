...
// user name pg-database to Host name/address in pg admin
...
python ingest_data.py \
  ...
  --url=${URL}
```
Running script for 2 urls

```bash
YELLOW_TRIPDATA_URL=https://github.com/DataTalksClub/nyc-tlc-data/releases/download/yellow/yellow_tripdata_2021-01.csv.gz
...
python3 ingest_data.py \
    ...
    --port=5434 \
    --db=ny_taxi \
    --first_table_name=yellow_taxi_trips \
    --second_table_name=zones \
    --yellow_tripdata_url=$YELLOW_TRIPDATA_URL \
    --zones_url=$ZONES_URL
